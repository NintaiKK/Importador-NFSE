...
def trabaio():
    ...
    #aqui da pau
    try:
        element0 = WebDriverWait(navegador, 10).until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="conteudo"]/div[1]/div/div/div[3]/div[2]/button'))
        )
    ...
    try:
        element12 = WebDriverWait(navegador, 10).until(
            EC.visibility_of_element_located((By.XPATH, '//*[@id="tblMeusRelatorios"]/tbody/tr[1]/td[4]/div/a[1]'))
        )
    ...
    navegador.find_element('xpath', '//*[@id="btnFecharModalRelatoriosAssincronos"]')
